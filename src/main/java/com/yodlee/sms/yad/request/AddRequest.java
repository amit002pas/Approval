...
public class AddRequest implements RequestDataParam {
	int sumInfoId;
	...
	public String toString() {
		return "AddRequest [sumInfoId=" + sumInfoId + ", startDateTime=" + startDateTime + ", endDateTime="
				+ endDateTime + ", expiryDate=" + expiryDate + ", recurrance=" + recurrance + ", notes=" + notes + "]";
	}
